...
# %% auto 0
__all__ = ['descarga_manzanas_identificadores', 'get_diccionario_censo', 'get_variables_censo', 'imputa_faltantes_manzana',
           'agrega_en_unidades', 'censo_a_tasas', 'get_uso_de_suelo', 'agrega_uso_suelo', 'IndicePCA']
...
def descarga_manzanas_identificadores() -> os.path:
    """ Descarga un gpkg con la geometría de las manzanes e identificadores de cuad4rantes y colonias.. """
    covariables_url = "https://www.dropbox.com/s/rsdezsy41vkityl/manzanas_identificadores.gpkg?dl=1"
