# AUTOGENERATED! DO NOT EDIT! File to edit: ../03_modelos.ipynb.

# %% auto 0
__all__ = ['variable_dependiente', 'variable_dependiente_serie', 'CapaDeAnalisis', 'ModeloGLM', 'ComparaModelos']
...
# %% ../03_modelos.ipynb 8
def variable_dependiente_serie(datos:pd.DataFrame, # carpetas/victimas con ids espaciales y categorías de usuario
                               columna_y:str, # Nombre de la columna en donde vienen los incidentes de valor_y
                               valores_y:list, # delitos o categorías a utilizar como Y
                               fecha_inicio:str, # fecha inicial para agregar delitos "d-m-Y"
                               fecha_fin: str, # fecha final para agregar delitos "d-m-Y"
                               agregacion:str='colonias', # colonias/cuadrantes/manzanas. Eventualmente debe recibir agregaciones arbitrarias (opcional)
                               nombres_y:list=None, # Lista con los nombres para las columnas con las variables dependientes (opcional, si se omite se concatenan los nombres de valores_y).
                               agregado:bool=False, # Agregamos o no los conteos de los valores_y
                               freq:str='1Y' # Frecuencia para la serie de tiempo (pandas)
                               ) -> pd.DataFrame:
    """ 
